...
foreach ($datastore in $datastores) {
    ...
    Write-Host "Unmap datastore:" $datastore
    $esxcli.storage.vmfs.unmap(200,$datastore.Name,$null)
    }

#Get-VMHostService -Server "srv03" -VMHost "esxhost" | where {$_.Label -like "SSH"} 