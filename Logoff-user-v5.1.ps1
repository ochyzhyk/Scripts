...
<Window x:Name="MyWindow" x:Class="WpfApplication1.TestWindow"
    ...
    <Grid Margin="0,0,2,-2">
        ...
        <TextBox x:Name="textBox" HorizontalAlignment="Left" Height="23" Margin="79,20,0,0" TextWrapping="Wrap" Text="" VerticalAlignment="Top" Width="180"/>
...
function Invoke-SQL {
    param(
        [string] $column,
        [string] $pattern
        #[string] $dataSource = "srv-dba00.ulf.local",
        #[string] $database = "RDS",
...
Function Get-Collection {
    ...
    $CollList=@((Invoke-SQL ("CollectionName") $Collection) | Where-Object {$_.UserName -eq $UserName})
